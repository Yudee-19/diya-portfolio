  ...
  return (
    <div className="w-full">
      ...
      <main className="relative w-full h-[100svh] bg-white overflow-hidden p-3 sm:p-5 flex flex-col">
        <div className="relative w-full flex-1 flex flex-col p-6 sm:p-14 md:p-24 font-sans text-black">
          
          {/* Top Right: Year */}
          <div className="absolute top-6 right-8 md:top-12 md:right-16 text-base sm:text-lg md:text-xl tracking-wider">
          ...
          {/* Center Content */}
          <div className="flex-1 w-full h-full relative mt-12 md:mt-4">
            
            {/* Left Text (Top Left) */}
            <div className="flex flex-col items-start z-10 absolute top-0 left-0 md:top-2 md:left-4">
              <ScrapbookItem direction="left" travelDistance={40} tiltSteps={3} duration={0.6} delay={0.1}>
                <h2 className="font-great-vibes text-5xl sm:text-7xl md:text-[8rem] leading-none mb-[-0.75rem] sm:mb-[-1rem] md:mb-[-1.5rem] ml-1 md:ml-3 font-normal text-black drop-shadow-sm">
                  Creative
                </h2>
              </ScrapbookItem>
              
              <ScrapbookItem direction="left" travelDistance={40} tiltSteps={3} duration={0.7} delay={0.3}>
                <h1 className="font-playfair text-[3.25rem] sm:text-[6rem] md:text-[8rem] font-bold tracking-tighter leading-none text-black">
                  PORTFOLIO
                </h1>
              </ScrapbookItem>
              
              <ScrapbookItem direction="left" travelDistance={30} tiltSteps={2} duration={0.5} delay={0.5}>
                <p className="font-sans text-lg sm:text-2xl mt-1 md:mt-2 tracking-wide font-normal text-gray-900 ml-1 md:ml-3">
                  Fashion Designer
                </p>
              </ScrapbookItem>
            </div>
            ...
            <div className="absolute bottom-10 right-0 md:bottom-6 md:right-8 lg:right-16 z-0 flex justify-end items-end">
              <ScrapbookItem direction="right" travelDistance={60} tiltSteps={4} duration={0.8} delay={0.4} maxAngle={15} finalRotation={5}>
                <Image 
                  src={heroFlower} 
                  alt="Vintage Flower Illustration" 
                  width={450} 
                  height={450}
                  className="w-44 h-44 sm:w-64 sm:h-64 md:w-[350px] md:h-[350px] lg:w-[450px] lg:h-[450px] object-contain drop-shadow-md"
                  priority
                />
              </ScrapbookItem>
            </div>
          ...
          {/* Bottom Elements */}
          <div className="absolute bottom-6 left-6 md:bottom-12 md:left-16 flex items-center gap-4">
