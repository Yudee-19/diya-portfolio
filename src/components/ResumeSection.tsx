            ...
            <div className="flex flex-col lg:flex-row gap-6 w-full justify-between items-start flex-1 min-h-0">
                ...
                <div className="w-full lg:w-1/3 flex flex-col gap-4 z-10">
                    ...
                    <div className="text-sm text-gray-800 leading-snug font-sans mt-2 max-w-sm">
                        <p className="mb-2">
                            Fashion Design graduate with hands-on experience in
                            fashion shows, styling, and collection development.
                            Skilled in Adobe Creative Suite and passionate about
                            blending contemporary aesthetics with sustainable
                            design.
                        </p>
                        <p>
                            Experienced in assisting photoshoots, garment
                            styling, and backstage coordination for live
                            showcases. Seeking opportunities in fashion design,
                            styling, or brand development.
                        </p>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-1/3 flex justify-center items-center relative min-h-[250px] lg:min-h-0 flex-1">
                    ...
                    <div className="absolute top-2 right-6 z-0 hidden lg:block scale-75">
                        ...
                        >
                            <path
                                d="M50 10 L50 30 M30 20 L40 35 M70 20 L60 35 M20 40 L35 45 M80 40 L65 45"
                                strokeLinecap="round"
                            />
                        </svg>
                    </div>
                ...
                >
                    <div className="flex items-center gap-2 mb-1 sticky top-0 bg-white z-10 py-1">
                        ...
                        <h3 className="font-sans font-bold text-base tracking-widest uppercase">
                            Experience
                        </h3>
                    </div>
                    ...
                    <div className="relative border-l-2 border-black ml-3 pl-4 pb-1 flex flex-col gap-4">
                        ...
                        <div className="relative">
                            ...
                            <h4 className="font-sans font-bold text-sm text-black mb-1">
                                Rohan Pariyar Studios – Intern
                            </h4>
                            <ul className="list-disc pl-4 text-xs text-gray-700 space-y-1 font-sans leading-snug">
                                <li>
                                    Contributed to the "I Medici" showcase at
                                    Victoria Memorial
                                </li>
                                <li>
                                    Assisted in garment styling, presentation,
                                    and backstage coordination
                                </li>
                                <li>
                                    Gained exposure to high-end fashion showcase
                                    production
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <ul className="list-disc pl-4 text-xs text-gray-700 space-y-1 font-sans leading-snug">
                                <li>
                                    Assisted in the launch of a new collection,
                                    contributing to styling and shoot
                                    preparation
                                </li>
                                <li>
                                    Worked closely with the jewellry brand{" "}
                                    <strong>Sawansukha</strong> for coordinated
                                    styling
                                </li>
                                <li>
                                    Supported creative direction for photoshoots
                        ...
                        <div className="relative">
                            <div className="absolute w-2.5 h-2.5 bg-black rounded-full -left-[1.35rem] top-1"></div>
                            <h4 className="font-sans font-bold text-sm text-black mb-1">
                                ICCR, Sutra Foundation – Fashion Show Assistant
                            </h4>
                            <ul className="list-disc pl-4 text-xs text-gray-700 space-y-1 font-sans leading-snug">
                                <li>
                                    Supported end-to-end execution of fashion
                                    shows, including backstage coordination and
                                    model management
                                </li>
                                <li>
                                    Assisted in styling and garment handling
                                    during live showcases
                                </li>
                                <li>
                                    Collaborated with designers and production
                                    teams to ensure smooth event flow
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div className="flex flex-col lg:flex-row gap-6 w-full items-start shrink-0">
                ...
                <div className="w-full lg:w-[28%] flex flex-col gap-4">
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <h3 className="font-sans font-bold text-base tracking-widest uppercase shrink-0">
                            Education
                        </h3>
                    ...
                    <div className="relative border-l-2 border-black ml-3 pl-4 flex flex-col gap-4">
                        <div className="relative">
                            ...
                            <h4 className="font-sans font-bold text-[0.8rem] text-black leading-snug">
                                Sister Nivedita University: 2022 – 2026
                            </h4>
                            <p className="text-xs text-gray-600 mt-0.5">
                                Bachelor in design (fashion & communication
                                designing)
                            </p>
                        </div>
                        <div className="relative">
                            <div className="absolute w-2 h-2 bg-black rounded-full -left-[1.3rem] top-1"></div>
                            <h4 className="font-sans font-bold text-[0.8rem] text-black leading-snug">
                                Teg Bahadur Public School: 2020 – 2022
                            </h4>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-3 gap-y-6 w-full">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-1.5">
                                ...
                                <h4 className="font-bold text-[0.7rem] uppercase leading-tight">
                                    Technical Skills
                                </h4>
                            </div>
